                                ...
                                <tbody>
                                    {recentLogs.map(l => (
                                        <tr key={l.id}>
                                            ...
                                            <td className="text-[10px] font-black uppercase text-slate-400 tracking-tighter">{l.timestamp.split(' ')[1]}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                                ...
                                {assets.map(a => (
                                    <div key={a.id} className="flex justify-between items-center p-5 rounded-2xl bg-white border border-slate-100 shadow-sm hover:border-accent/40 transition-all group">
                                        <div>
                                            ...
                                            <p className="text-[9px] text-slate-400 tracking-[0.2em] uppercase font-black mt-1 font-mono">{a.id}</p>
                                        </div>
